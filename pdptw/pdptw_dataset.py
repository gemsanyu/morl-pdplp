...
from pdptw.utils import RANDOM, RANDOMCLUSTER, CLUSTER, CENTRAL, read_graph

class PDPTW_Dataset(Dataset):
    def __init__(self,
        ...
        super(PDPTW_Dataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        max_capacity = mc
        return index, nv, max_capacity, coords, norm_coords, demands, norm_demands, pt, time_windows, norm_time_windows, service_durations, norm_service_durations, distance_matrix, norm_distance_matrix
